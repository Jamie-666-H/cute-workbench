...
def inj_lrc(idv):
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0'})
    return len(urllib.request.urlopen(req, timeout=10).read())

songs = [
    ('颜人中', ['夏天', '告白', '那个男孩', '起风了', '谁的明天', '好不好', '多想', '靠近', '夏夜最后的烟火', '你想要的']),
    ('张新成', ['莎士比哑', '第57次取消发送', '我也不在', '晚安星光冻', '是你没选我啊', '与你有关的秘密', '这世界总会让你遍体鳞伤', '梦想的模样', '自言自语', '靠近我']),
]
result = {}
